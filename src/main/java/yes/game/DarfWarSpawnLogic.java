...
public class DarfWarSpawnLogic {
    private final GameSpace gameSpace;
    private final DarfWarMap map;

    public DarfWarSpawnLogic(GameSpace gameSpace, DarfWarMap map) {
    ...
    public void spawnPlayer(ServerPlayerEntity player) {
        ...
        if (pos == null) {
            DarfWar.LOGGER.error("Cannot spawn player! No spawn is defined in the map!");
            return;
        }
